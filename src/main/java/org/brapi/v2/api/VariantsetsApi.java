...
public interface VariantsetsApi {
    ...
    @RequestMapping(value = CallsApi.URL_BASE_PREFIX + "/variantsets/extract",
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 401, message = "Unauthorized", response = String.class),
        @ApiResponse(code = 403, message = "Forbidden", response = String.class) })
    @RequestMapping(value = CallsApi.URL_BASE_PREFIX + "/variantsets",
        produces = { "application/json" }, 
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 401, message = "Unauthorized", response = String.class),
        @ApiResponse(code = 403, message = "Forbidden", response = String.class) })
    @RequestMapping(value = CallsApi.URL_BASE_PREFIX + "/variantsets/{variantSetDbId}/calls",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 401, message = "Unauthorized", response = String.class),
        @ApiResponse(code = 403, message = "Forbidden", response = String.class) })
    @RequestMapping(value = CallsApi.URL_BASE_PREFIX + "/variantsets/{variantSetDbId}/callsets",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 403, message = "Forbidden", response = String.class),
        @ApiResponse(code = 404, message = "Not Found", response = String.class) })
    @RequestMapping(value = CallsApi.URL_BASE_PREFIX + "/variantsets/{variantSetDbId}",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 401, message = "Unauthorized", response = String.class),
        @ApiResponse(code = 403, message = "Forbidden", response = String.class) })
    @RequestMapping(value = CallsApi.URL_BASE_PREFIX + "/variantsets/{variantSetDbId}/variants",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
