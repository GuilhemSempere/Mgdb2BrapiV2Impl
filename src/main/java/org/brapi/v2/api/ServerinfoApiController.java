...
public class ServerinfoApiController implements ServerinfoApi {
	...
	public ResponseEntity<CallsResponse> serverinfoGet(@ApiParam(value = "The data format supported by the call.") @Valid @RequestParam(value = "dataType", required = false) ContentTypes dataType,@ApiParam(value = "HTTP HEADER - Token used for Authorization   <strong> Bearer {token_string} </strong>" ) @RequestHeader(value="Authorization", required=false) String authorization) {
		...
		result.addCallsItem(new Service() {{ getVersions().add(VersionsEnum._1); getMethods().add(MethodsEnum.GET); setService(ReferencesetsApi.referencesetsGet_url); setContentTypes(new ArrayList<ContentTypes>() {{ add(ContentTypes.fromValue("application/json")); }}); }});
		result.addCallsItem(new Service() {{ getVersions().add(VersionsEnum._1); getMethods().add(MethodsEnum.GET); setService(ReferencesApi.referencesGet_url); setContentTypes(new ArrayList<ContentTypes>() {{ add(ContentTypes.fromValue("application/json")); }}); }});
		...
		result.addCallsItem(new Service() {{ getVersions().add(VersionsEnum._0); getMethods().add(MethodsEnum.GET); setService(VariantsetsApi.variantsetsVariantSetDbIdCallsGet_url); setContentTypes(new ArrayList<ContentTypes>() {{ add(ContentTypes.fromValue("application/json")); }}); }});
		...
		result.addCallsItem(new Service() {{ getVersions().add(VersionsEnum._0); getMethods().add(MethodsEnum.GET); setService(VariantsApi.variantsVariantDbIdCallsGet_url); setContentTypes(new ArrayList<ContentTypes>() {{ add(ContentTypes.fromValue("application/json")); }}); }});
		...
		result.addCallsItem(new Service() {{ getVersions().add(VersionsEnum._1); getMethods().add(MethodsEnum.POST); setService(ReferencesetsApi.searchReferenceSetsPost_url); setContentTypes(new ArrayList<ContentTypes>() {{ add(ContentTypes.fromValue("application/json")); }}); }});
		result.addCallsItem(new Service() {{ getVersions().add(VersionsEnum._1); getMethods().add(MethodsEnum.POST); setService(ReferencesApi.searchReferencesPost_url); setContentTypes(new ArrayList<ContentTypes>() {{ add(ContentTypes.fromValue("application/json")); }}); }});
